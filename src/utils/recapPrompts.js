...
export function buildWeekRecapPrompt(dynasty, year, week) {
  ...
  return [
    ...
    `   3. BANNED PHRASES: did you write any of the column-mode phrases above? ("did not X so much as Y", "the cleanest version", "perfection and momentum", "[Month] punishes", "season died in [city]", "bracket drew itself", etc.)`,
    ...
    `   5. CLOSING: does the recap end on a fact — not a column-y oracle about months, brackets, or momentum?`,
    ``,
