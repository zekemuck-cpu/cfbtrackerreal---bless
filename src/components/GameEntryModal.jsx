...
export default function GameEntryModal({
  ...
  // Recap depth slider: 10 stops — Scoreline → Epic. Controls how long/detailed
  // the AI prompt instructs the AI to write. Persisted in localStorage.
  ...
  return (
    <div
      className="fixed inset-0 top-0 left-0 right-0 bottom-0 bg-black bg-opacity-70 flex items-center justify-center z-[9999] py-8 px-4 sm:p-4 backdrop-blur-sm"
      style={{ margin: 0 }}
      onMouseDown={onClose}
    >
      <div
          ...
          <div className="rounded-xl p-4 sm:p-5 shadow-sm" style={{ backgroundColor: 'var(--surface-3)', border: `1px solid ${'var(--surface-4)'}` }}>
            <div className="flex items-center justify-between mb-4">
              ...
              {(() => {
                ...
                // Mirrors the team1/team2 ordering buildGameRecapContext uses.
