...
export default function DraftResultsModal({ isOpen, onClose, onSave, currentYear, teamColors }) {
  ...
  useEffect(() => {
    ...
    createSheet()
  }, [isOpen, user, sheetId, creatingSheet, currentDynasty?.id, retryCount, showDeletedNote, noDraftDeclarees, currentYear])
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center p-8 rounded-lg" style={{ backgroundColor: `${modalColors.accent}20` }}>
              ...
              <button
                ...
                style={{ backgroundColor: modalColors.accent, color: modalColors.background }}
              >
                Continue
              </button>
            </div>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center p-8 rounded-lg" style={{ backgroundColor: modalColors.accent }}>
              ...
              <p className="text-sm" style={{ color: modalColors.background, opacity: 0.9 }}>
                Draft results saved to your dynasty.
              </p>
            </div>
          </div>
        ) : sheetId ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center p-4">
                ...
                <div className="text-left mb-6 max-w-sm">
                  ...
                  <ol className="text-sm space-y-1.5" style={{ color: modalColors.textMuted }}>
                    ...
                    <li className="flex gap-2"><span className="font-bold">2.</span><span>Players who declared for the draft are pre-filled</span></li>
                    <li className="flex gap-2"><span className="font-bold">3.</span><span>Select the draft round for each player (1st-7th or Undrafted)</span></li>
