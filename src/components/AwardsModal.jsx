        ...
        {isLoading ? (
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-lg font-semibold" style={{ color: teamColors.primary }}>Creating Awards Sheet...</p>
            </div>
          </div>
        ) : showDeletedNote ? (
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center p-8 rounded-lg" style={{ backgroundColor: teamColors.primary }}>
              ...
              <p className="text-sm" style={{ color: teamColors.secondary, opacity: 0.9 }}>Season awards saved.</p>
            </div>
          </div>
        ) : sheetId ? (
