    ...
    <div className="fixed inset-0 top-0 left-0 right-0 bottom-0 bg-black bg-opacity-60 flex items-center justify-center z-[9999] py-8 px-4 sm:p-4" style={{ margin: 0 }} onMouseDown={handleClose}>
      <div className="rounded-xl border shadow-xl w-full sm:w-[95vw] max-h-[calc(100vh-4rem)] sm:h-[95vh] flex flex-col p-4 sm:p-6" style={{ backgroundColor: modalColors.background, borderColor: modalColors.border }} onMouseDown={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-bold" style={{ color: modalColors.text }}>{currentYear} Season Awards</h2>
        ...
        {isLoading ? (
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-lg font-semibold" style={{ color: modalColors.text }}>Creating Awards Sheet...</p>
            </div>
          </div>
        ) : showDeletedNote ? (
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center p-8 rounded-lg" style={{ backgroundColor: modalColors.accent }}>
              ...
              <p className="text-sm" style={{ color: modalColors.background, opacity: 0.9 }}>Season awards saved.</p>
            </div>
          </div>
        ) : sheetId ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center p-4">
                ...
                <div className="text-left mb-4 max-w-xs">
                  ...
                  <ol className="text-sm space-y-1.5" style={{ color: modalColors.textMuted }}>
                    ...
                    <li className="flex gap-2"><span className="font-bold">2.</span><span>Enter award winners (Player, Position, Team, Class)</span></li>
