...
// ---------------------------------------------------------------------------
// BATCH 4 — Syracuse through Wyoming (FINAL BATCH — all FBS teams complete)
// ---------------------------------------------------------------------------
const BATCH_4 = {
  "Syracuse Orange": {
    primaryPMS: "PMS 158 C",
    primaryHex: "#F76900",
    secondaryPMS: "PMS 281 C",
    secondaryHex: "#000E54",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "orange",
    awayJerseyColor: "white",
    graphicNotes: "Syracuse Orange (PMS 158, #F76900) is brighter and more saturated than Tennessee or Texas orange — closer to safety/construction orange. Single-color identity is the brand's signature — orange is the school nickname itself. Navy (PMS 281) is a deep accent, never replacing orange.",
    shortNickname: "Cuse",
    confidence: "high"
  },
  "TCU Horned Frogs": {
    ...
    homeJerseyColor: "purple",
    awayJerseyColor: "white",
    graphicNotes: "Horned Frog Purple (PMS 268, #4D1979) is a deep cool purple — never confuse with red-purple/magenta. The horned frog mascot is uniquely TCU (no other major program uses it). Chrome/iridescent frog-skin helmet treatments are a signature modern motif.",
    shortNickname: "Frogs",
    confidence: "high"
  },
  "Temple Owls": {
    ...
    awayJerseyColor: "white",
    graphicNotes: "Temple's cherry red (PMS 201, #9D2235) is darker than typical scarlet — never substitute scarlet or crimson. Per Temple brand guide the Temple T box MUST be cherry red — no other box colors are allowed. Modern owl-head logo is sharp and geometric.",
    shortNickname: "Temple",
    confidence: "high"
  },
  "Tennessee Volunteers": {
    primaryPMS: "PMS 151 C",
    primaryHex: "#FF8200",
    secondaryPMS: "PMS 425 C",
    secondaryHex: "#58595B",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "orange",
    awayJerseyColor: "white",
    graphicNotes: "Tennessee Orange is PMS 151 (#FF8200) — extremely vivid, NEVER dull it down or shift toward burnt/dark orange. The orange-and-white checkerboard pattern (first appeared at the Boston College game on October 10, 1964) is non-negotiable as a background texture. Power T on white helmet with single orange center stripe is iconic.",
    shortNickname: "Vols",
    confidence: "high"
  },
  "Texas Longhorns": {
    primaryPMS: "PMS 159 C",
    primaryHex: "#BF5700",
    secondaryPMS: "PMS 432 C",
    secondaryHex: "#333F48",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "white",
    awayJerseyColor: "white",
    graphicNotes: "Burnt Orange (PMS 159, #BF5700) is sacred — NEVER use bright/safety orange or red-orange. Texas wears white as the dominant jersey base at home and away — burnt orange jerseys are rare alternates. The longhorn steer silhouette is the only logo that matters; minimalism is the brand.",
    shortNickname: "Horns",
    confidence: "high"
  },
  "Texas AM Aggies": {
    primaryPMS: "PMS 7421 C",
    primaryHex: "#500000",
    secondaryPMS: null,
    secondaryHex: "#FFFFFF",
    tertiaryHex: "#000000",
    ...
    homeJerseyColor: "maroon",
    awayJerseyColor: "white",
    graphicNotes: "Aggie Maroon (PMS 7421, #500000) is extremely dark — almost black-maroon, NEVER use bright crimson or burgundy. The ATM block interlock and '12th Man' military-tradition themes are central; identity is restrained and traditional. Avoid gold accents (those are A&M System branding, not athletics).",
    shortNickname: "Aggies",
    confidence: "high"
  },
  "Texas State Bobcats": {
    primaryPMS: "PMS 504 C",
    primaryHex: "#501214",
    secondaryPMS: "PMS 872 C",
    secondaryHex: "#8D734A",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "maroon",
    awayJerseyColor: "white",
    graphicNotes: "Texas State maroon (PMS 504, #501214) is very dark and slightly brown-toned, paired with a metallic-feeling old gold (PMS 872) rather than yellow. Bobcat head with sharp angular features is the signature mark. Avoid confusion with Texas A&M maroon — Texas State's is browner.",
    shortNickname: "Bobcats",
    confidence: "high"
  },
  "Texas Tech Red Raiders": {
    ...
    homeJerseyColor: "red",
    awayJerseyColor: "white",
    graphicNotes: "Texas Tech scarlet (PMS 186, #CC0000) is bright pure red, not crimson or burgundy. The Double T monogram is THE mark — must be drawn with the correct proportions (front T overlapping larger back T). Black is a heavy secondary; western/Masked Rider imagery accents the brand.",
    shortNickname: "Tech",
    confidence: "high"
  },
  "Toledo Rockets": {
    ...
    awayJerseyColor: "white",
    graphicNotes: "Toledo's midnight blue (PMS 281, #15397F) is a deep navy, paired with bright gold (PMS 116, #FFDA00) — never mix with metallic/Vegas gold. Matte blue helmets with 'GLASS CITY' bumper text are a recent signature touch. Rocket imagery is the visual motif.",
    shortNickname: "Toledo",
    confidence: "high"
  },
  "Troy Trojans": {
    primaryPMS: "PMS 202 C",
    primaryHex: "#862633",
    secondaryPMS: "PMS Cool Gray 5 C",
    secondaryHex: "#B1B1B1",
    tertiaryHex: "#000000",
    ...
    awayJerseyColor: "white",
    graphicNotes: "Troy cardinal (PMS 202, #862633) is darker than scarlet, closer to A&M maroon but with more red. Trojan T-with-sword mark is core; Cool Gray 5 (not silver) is the proper secondary per Troy's brand guide. Avoid confusion with USC's brighter cardinal.",
    shortNickname: "Troy",
    confidence: "high"
  },
  "Tulane Green Wave": {
    ...
    awayJerseyColor: "white",
    graphicNotes: "Tulane's unique olive-green-and-sky-blue combo (PMS 342 dark green + PMS 279 sky blue) is unlike any other program — NEVER substitute kelly or forest green. The throwback 'Angry Wave' logo (reintroduced June 30, 2016) and multi-stripe helmet pattern are signature. New Orleans fleur-de-lis is a regional accent.",
    shortNickname: "Tulane",
    confidence: "high"
  },
  "Tulsa Golden Hurricane": {
    primaryPMS: "PMS 288 C",
    primaryHex: "#002D72",
    secondaryPMS: "PMS 186 C",
    secondaryHex: "#C8102E",
    tertiaryHex: "#C5B783",
    ...
    homeJerseyColor: "navy blue",
    awayJerseyColor: "white",
    graphicNotes: "Tulsa is navy/red/old-gold — three colors, not blue/gold — distinct from most 'golden' nicknamed teams. The cursive 'Tulsa' script and storm-flag/hurricane motif are signature. Old gold (PMS 4525, #C5B783) is muted/khaki, not bright yellow.",
    shortNickname: "Tulsa",
    confidence: "high"
  },
  "UAB Blazers": {
    ...
    homeJerseyColor: "green",
    awayJerseyColor: "white",
    graphicNotes: "UAB's forest green (#1C5420) paired with bright gold and dragon-with-flame imagery is unique. The dragon mascot 'Blaze' and flame motifs are key — the team is named 'Blazers' so fire is on-brand. Avoid Oregon/Baylor-style brighter greens.",
    shortNickname: "UAB",
    confidence: "medium"
  },
  "UCF Knights": {
    ...
    homeJerseyColor: "black",
    awayJerseyColor: "white",
    graphicNotes: "Modern UCF identity is sleek black and bright gold — Pegasus winged-horse logo is the modern primary mark (the retired 'Citronaut' is NOT used). 'Space U' branding ties to nearby Kennedy Space Center. High-contrast, futuristic feel.",
    shortNickname: "UCF",
    confidence: "high"
  },
  "UCLA Bruins": {
    primaryPMS: "PMS 2383 C",
    primaryHex: "#2774AE",
    secondaryPMS: "PMS 109 C",
    secondaryHex: "#FFD100",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "blue",
    awayJerseyColor: "white",
    graphicNotes: "UCLA blue (#2774AE) is brighter/more saturated than navy — closer to true blue. The UCLA script wordmark across the chest is iconic and non-negotiable — no other program does this. The signature 'shoulder loops' / striped sleeve pattern on jerseys is also distinctive. Blue is more important than gold (a field of gold with a blue accent does NOT say UCLA).",
    shortNickname: "UCLA",
    confidence: "high"
  },
  "UMass Minutemen": {
    ...
    homeJerseyColor: "maroon",
    awayJerseyColor: "white",
    graphicNotes: "UMass maroon (PMS 202) is a true crimson-maroon, brighter than A&M's. Colonial-patriot Minuteman with musket is the spirit symbol — Revolutionary War heritage is central to the brand. Conservative, traditional collegiate look.",
    shortNickname: "UMass",
    confidence: "medium"
  },
  "UNLV Rebels": {
    ...
    homeJerseyColor: "scarlet",
    awayJerseyColor: "white",
    graphicNotes: "UNLV scarlet (PMS 186) is bright pure red; the Hey Reb! mascot was formally retired on January 19, 2021 — do NOT include it. Current identity leans on the bold angular 'UNLV' lettermark and Las Vegas/Strip themes. Scarlet + gray + black is the palette.",
    shortNickname: "UNLV",
    confidence: "medium"
  },
  "USC Trojans": {
    ...
    homeJerseyColor: "cardinal",
    awayJerseyColor: "white",
    graphicNotes: "USC Cardinal (PMS 201, #990000) is a deep classic cardinal — never bright red. Gold is PMS 123 (#FFCC00), bright yellow-gold. The Trojan helmet with warrior profile and the interlocking SC are both iconic — extremely traditional brand, no flashy alternates. USC Cardinal and USC Gold are of EQUAL importance per brand guide.",
    shortNickname: "USC",
    confidence: "high"
  },
  "Utah Utes": {
    ...
    homeJerseyColor: "red",
    awayJerseyColor: "white",
    graphicNotes: "Utah red (PMS 200) is bright crimson-red. The Drum & Feather circular mark is signature (Ute Tribe authorized) — feathered stripe down the helmet is also iconic. Utah frequently rotates matte black, chrome, and red helmets.",
    shortNickname: "Utes",
    confidence: "high"
  },
  "Utah State Aggies": {
    primaryPMS: "PMS 539 C",
    primaryHex: "#00263A",
    secondaryPMS: "PMS 877 C",
    secondaryHex: "#8A8D8F",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "navy blue",
    awayJerseyColor: "white",
    graphicNotes: "Aggie Blue (PMS 539, #00263A) is a very dark navy — almost black-blue. Clean A-on-helmet identity. Silver/gray (not white) is the proper secondary.",
    shortNickname: "Aggies",
    confidence: "medium"
  },
  "UTEP Miners": {
    ...
    homeJerseyColor: "navy blue",
    awayJerseyColor: "white",
    graphicNotes: "UTEP navy + bright orange (#FF8200) is distinctive; pickaxe imagery and mining/desert heritage are signature. The italicized UTEP monogram and crossed pickaxes are key motifs.",
    shortNickname: "Miners",
    confidence: "medium"
  },
  "UTSA Roadrunners": {
    primaryPMS: "PMS 289 C",
    primaryHex: "#0C2340",
    secondaryPMS: "PMS 1665 C",
    secondaryHex: "#F15A22",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "navy blue",
    awayJerseyColor: "white",
    graphicNotes: "UTSA navy (#0C2340) is very dark, paired with bright orange (#F15A22). The roadrunner head silhouette (sharp beak, distinctive head crest) is the signature mark. One of CFB's newer programs (est. 2011) with a sharp modern look; 'Birds Up' hand sign is a fan signature.",
    shortNickname: "UTSA",
    confidence: "medium"
  },
  "Vanderbilt Commodores": {
    ...
    homeJerseyColor: "black",
    awayJerseyColor: "white",
    graphicNotes: "Vanderbilt gold (PMS 873) is METALLIC old gold — muted, never bright yellow. Naval/commodore theme central — anchor and 'Anchor Down' are signature. Star V is the primary on-field mark.",
    shortNickname: "Vandy",
    confidence: "medium"
  },
  "Virginia Cavaliers": {
    primaryPMS: "PMS 533 C",
    primaryHex: "#232D4B",
    secondaryPMS: "PMS 172 C",
    secondaryHex: "#F84C1E",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "navy blue",
    awayJerseyColor: "white",
    graphicNotes: "UVA's Jefferson Blue (#232D4B) is a deep dark navy paired with bright orange (#F84C1E, not burnt orange). Crossed sabres under V is the signature athletics mark. Classical Jeffersonian/Rotunda heritage means serif typography unlike most college brands.",
    shortNickname: "Hoos",
    confidence: "high"
  },
  "Virginia Tech Hokies": {
    ...
    homeJerseyColor: "maroon",
    awayJerseyColor: "white",
    graphicNotes: "Virginia Tech's color combo of Chicago Maroon (PMS 208, #630031) + Burnt Orange (PMS 158, #CF4420) is unique in college sports — adopted 1896. The VT interlocking monogram is the only logo. Hokie Stone (gray limestone from campus buildings) is a signature texture motif; HokieBird mascot is the turkey character.",
    shortNickname: "Hokies",
    confidence: "high"
  },
  "Wake Forest Demon Deacons": {
    primaryPMS: "PMS 8640 C",
    primaryHex: "#9E7E38",
    secondaryPMS: "PMS Black 6 C",
    secondaryHex: "#000000",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "black",
    awayJerseyColor: "white",
    graphicNotes: "Wake Forest's metallic old gold helmets (#9E7E38, PMS 8640 metallic) are one of CFB's most distinctive — true metallic finish, not yellow gold. The top-hatted Demon Deacon mascot (formal black suit, umbrella) is a beloved spirit mark. Interlocking WF is the athletic logo.",
    shortNickname: "Deacs",
    confidence: "high"
  },
  "Washington Huskies": {
    ...
    homeJerseyColor: "purple",
    awayJerseyColor: "white",
    graphicNotes: "Husky Purple (PMS 2685, #4B2E83) is a rich deep purple, paired with warm muted Husky Gold (PMS 7502, #B7A57A) — NOT bright yellow gold. The block W is the dominant mark. Per UW brand guide, purple is more important than gold — a field of gold with purple accent does NOT say UW.",
    shortNickname: "Dawgs",
    confidence: "high"
  },
  "Washington State Cougars": {
    primaryPMS: "PMS 7622 C",
    primaryHex: "#981E32",
    secondaryPMS: "PMS 431 C",
    secondaryHex: "#5E6A71",
    tertiaryHex: "#FFFFFF",
    motifs: ["Cougar head"],
    ...
    homeJerseyColor: "crimson",
    awayJerseyColor: "white",
    graphicNotes: "WSU crimson (PMS 7622, #981E32) is deeper/darker than scarlet, paired with cool gray (not silver). The snarling Cougar head profile is one of the most iconic logos in CFB — sharp angular features, fangs visible. 'Go Cougs' is the rallying cry.",
    shortNickname: "Cougs",
    confidence: "high"
  },
  "West Virginia Mountaineers": {
    ...
    homeJerseyColor: "navy blue",
    awayJerseyColor: "white",
    graphicNotes: "WVU's 'Flying WV' logo (gold on navy) is one of the most recognized in CFB — the W+V silhouette evokes mountains. Old Gold (PMS 124, #EAAA00) is bright and saturated, paired with deep navy blue (PMS 295, #002855). Coonskin-cap Mountaineer mascot with musket is the spirit symbol.",
    shortNickname: "Mountaineers",
    confidence: "high"
  },
  "Western Kentucky Hilltoppers": {
    ...
    homeJerseyColor: "red",
    awayJerseyColor: "white",
    graphicNotes: "WKU red (PMS 186, #C60C30) is bright scarlet. 'Big Red' — the beloved round furry red blob mascot — is one of CFB's most unique mascots and a key visual signature. Campus-hilltop tower silhouette is referenced in the primary mark.",
    shortNickname: "Tops",
    confidence: "medium"
  },
  "Western Michigan Broncos": {
    ...
    awayJerseyColor: "white",
    graphicNotes: "WMU's brown/gold combo (gold #B5A167 as primary, brown #6C4023 as accent) is rare in CFB. The Bronco head with flowing mane that forms a W is the signature logo. 'Ghost Bronco' outline-only treatment is used for stylized versions.",
    shortNickname: "Broncos",
    confidence: "medium"
  },
  "Wisconsin Badgers": {
    ...
    homeJerseyColor: "red",
    awayJerseyColor: "white",
    graphicNotes: "Badger Red (PMS 200, #C5050C) — officially called cardinal red — is the only true Wisconsin red. The Motion W (red with black 3D shadow) is the signature mark and is non-negotiable. Bucky Badger (striped cardinal-and-white sweater) is the beloved mascot.",
    shortNickname: "Badgers",
    confidence: "high"
  },
  "Wyoming Cowboys": {
    primaryPMS: "PMS 476 C",
    primaryHex: "#492F24",
    secondaryPMS: "PMS 123 C",
    secondaryHex: "#FFC425",
    tertiaryHex: "#FFFFFF",
    ...
    homeJerseyColor: "brown",
    awayJerseyColor: "white",
    graphicNotes: "Wyoming Brown (PMS 476, #492F24) is a dark earthy brown — paired with bright gold (PMS 123). The Steamboat bucking horse-and-rider silhouette (also on the Wyoming state license plate) is one of CFB's most distinctive logos. Deeply tied to Wyoming cowboy/ranching heritage.",
    shortNickname: "Pokes",
    confidence: "high"
  }
}
