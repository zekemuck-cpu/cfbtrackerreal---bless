...
describe('buildLeagueDraftResults', () => {
  const players = [
    { asset_name: 'SayinJulian_1', first_name: 'Julian', last_name: 'Sayin', position: 'QB', year: 'Junior', overall: 94, team_id: 68 },
    { asset_name: 'SmithJeremiah_2', first_name: 'Jeremiah', last_name: 'Smith', position: 'WR', year: 'Junior', overall: 99, team_id: 68 },
    { asset_name: 'InnissBrandon_3', first_name: 'Brandon', last_name: 'Inniss', position: 'WR', year: 'Senior', overall: 88, team_id: 68 },
  ]
  ...
  it('resolves a whole-league draft class from EarlyNFL_* leaving-player rows', () => {
    ...
    expect(result).toEqual([
      { playerName: 'Julian Sayin', position: 'QB', classYear: 'Junior', overall: 94, tid: 194, draftRound: '1st Round', round: 1 },
      { playerName: 'Jeremiah Smith', position: 'WR', classYear: 'Junior', overall: 99, tid: 194, draftRound: '1st Round', round: 1 },
      { playerName: 'Brandon Inniss', position: 'WR', classYear: 'Senior', overall: 88, tid: 194, draftRound: '6th Round', round: 6 },
    ])
  })
