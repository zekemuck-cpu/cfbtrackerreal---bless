...
import { generateGameRecap, getGeminiApiKey } from '../../services/geminiService'
...
export default function Game() {
  ...
  const handleGenerateRecap = async () => {
    ...
    try {
      ...
      // Generate the recap
      const recap = await generateGameRecap(currentDynasty, game, apiKey)

      // Save the recap to the game
      const existingGames = currentDynasty.games || []
      const gameIndex = existingGames.findIndex(g => g.id === gameId)
          ...
          <div className="p-4">
            {game.aiRecap ? (
              <div className="space-y-4">
                ...
                {game.aiRecapGeneratedAt && (
                  <div className="text-xs text-gray-500 pt-2 border-t border-gray-800">
                    Generated {new Date(game.aiRecapGeneratedAt).toLocaleDateString()}
                  </div>
                )}
              </div>
            ) : (
