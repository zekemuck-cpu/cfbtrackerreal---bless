    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300 leading-relaxed">
            Google Sheets is the primary method for entering data into the app. The app can only access spreadsheets you explicitly connect. We use the <code className="bg-gray-800 px-1 rounded">drive.file</code> scope, which limits access to files you create or open with the app.
          </p>
        </section>
